...
Nesse desafio, você irá desenvolver mais uma aplicação, a GoRestaurant. Agora você irá praticar o que você aprendeu até agora no ReactJS junto com TypeScript, praticando o conceito de CRUD (Create, Read, Update, Delete).
...
**Dica**: Ao editar um item, quando for envia-lo para o back-end, lembre de copiar os dados anteriores como o `available` e o `id`, ou eles serão  perdidos do seu arquivo server.json.
